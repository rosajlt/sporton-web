                ...
                <div className="min-w-50">
                  <ImageUploadPreview label="Category Image" value={imagePreview} onChange={
                    ...
                    <div className="input-group-admin">
                         ...
                         <textarea id="description" name="description" rows={4} placeholder="Category Details..."></textarea>
                     </div>
                </div>
            </div>
          <Button size="normal" variant="primary" className="ml-auto mt-3 rounded-lg">Create Category</Button>
