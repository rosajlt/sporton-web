                  ...
                  <ImageUploadPreview label="Category Image" value={imagePreview} onChange={
                    ...
                    <div className="flex flex-col gap-4 w-full">
                      <div className="input-group-admin">
                         ...
                         <input type="text" id="name" name="name" placeholder="e. g. Running Shoes" value={formData.name} onChange={handleInputChange}/>
                       </div>
                       
                    <div className="input-group-admin">
                         <label htmlFor="description">Description</label>
                         <textarea id="description" name="description" rows={4} placeholder="Category Details..." value={formData.description} onChange={handleInputChange}></textarea>
                     </div>
                </div>
            </div>
